...
### The Proof Verification Imperative

**Failure case:** Claimed 100% on an open conjecture. Peer review found fatal gaps. Actual confidence should have been ~60-70%.

**The failures:**
- Inherited proof structure without rebuilding it myself
- Added text that "looked like" it closed gaps (text ≠ proof)
- Only tested cases where the method happened to work
- Updated confidence because I added content, not because I verified logic
